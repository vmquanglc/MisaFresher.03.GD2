...
namespace MISA.WebFresher2023.Demo.Controllers
{
    ...
    public class NationController : BaseController<Nation, NationDto, NationCreateDto, NationUpdateDto>
    {
        ...
        {
            IEnumerable<NationDto> list = await _baseService.GetAllAsync();

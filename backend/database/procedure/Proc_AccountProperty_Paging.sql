...
PROCEDURE `misa.web202303_mf1609_leductiep`.Proc_AccountProperty_Paging (IN _offset int,
IN _limit int,
...
BEGIN
  ...
  WHERE COALESCE(a.Name,'')  LIKE concat('%', searchTerm, '%')
...
CALL Proc_AccountProperty_Paging(0, 20, '', @totalRecord);

CREATE OR REPLACE PROCEDURE `misa.web202303_mf1609_leductiep`.Proc_BookKeeping_Delete (IN bookKeepingId char(36))
COMMENT '
...
BEGIN
  DELETE
    FROM bookkeeping
  WHERE bookkeeping.bookKeepingId = bookKeepingId;
END; 
